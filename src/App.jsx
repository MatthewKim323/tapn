...
function App() {
  const { isLoading, isIntroComplete, triggerZoom, navigationState } = useSceneStore();
  ...
  // Memoize the 3D galaxy canvas so it doesn't re-mount
  ...
  return (
    <div className="app-container" onMouseMove={handleMouseMove}>
      ...
      {/* Layer 1: Interactive galaxy shader background (stars + nebula) */}
      ...
      {/* Layer 2: 3D Galaxy model with bloom (transparent canvas on top) */}
      {galaxySceneCanvas}
